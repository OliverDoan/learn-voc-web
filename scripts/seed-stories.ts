...
const STORIES: Array<{ deckName: string; title: string; content: string }> = [
  {
    ...
    content: `Một người hàng xóm [[friendly|thân thiện]] sang [[inform|thông báo]] rồi [[invite|mời]] tôi và bạn gái sang chơi. Khu này là một [[safe|an toàn]], [[vibrant|sôi động]] [[area|khu vực]] vừa mới [[develop|phát triển]] — cả một [[block|khu nhà]] khang trang.
...
Phía dưới có [[playground|sân chơi]] và [[pool|bể bơi]]; cây xanh [[everywhere|khắp mọi nơi]]. Tôi — biệt danh Sunny — mỉm cười.`,
  },
  {
    ...
    content: `[[nowadays|ngày nay]], [[travelling|du lịch]] dễ hơn nhiều. Tôi và bạn gái rất [[excited|hào hứng]] chọn một [[huge|khổng lồ]] [[destination|điểm đến]] mới, xin [[visa|thị thực]] và đặt [[reservation|sự đặt chỗ]].
...
Họ đi một [[tour|chuyến tham quan]] cùng nhiều [[tourist|khách du lịch]] khác. Mỗi [[moment|khoảnh khắc]] thành một [[memory|kỉ niệm]] đẹp; cô ấy gửi một [[postcard|bưu thiếp]] về cho gia đình.`,
  },
  {
    ...
    content: `Tôi và bạn gái dành ngày [[leisure|thời gian rảnh]] đi [[sightseeing|ngắm cảnh]] cùng một [[local|địa phương]] [[guide|hướng dẫn viên]]. Anh chọn một [[route|tuyến đường]] giàu [[history|lịch sử]].
...
Chỗ nghỉ có nhiều kiểu: một [[resort|khu nghỉ dưỡng]], một [[campsite|khu cắm trại]], hay một [[homestay|dịch vụ nghỉ tại nhà dân]]. Sáng hôm sau, hai người cùng [[hike|đi bộ đường dài]].`,
  },
  {
    ...
    content: `[[generally|nhìn chung]], người Việt rất thích [[celebration|sự ăn mừng]]; mỗi [[occasion|dịp đặc biệt]] là một lần sum họp.
...
Trước [[holiday|ngày lễ]], tôi và bạn gái [[tidy|dọn dẹp]] nhà, [[exchange|trao đổi]] quà cho [[loved one|người thân yêu]] — cũng là [[anniversary|ngày kỉ niệm]] ngày hai người quen nhau.`,
  },
  {
    ...
    content: `Tôi và bạn gái nghĩ về [[difference|sự khác biệt]] văn hoá: điều [[normal|bình thường]] nơi này có thể [[strange|kì lạ]] nơi khác, nên cần [[respect|tôn trọng]] và [[fair|công bằng]].
...
Đừng cố [[control|điều khiển]] hay [[persuade|thuyết phục]] ai đổi thay; cởi mở rồi văn hoá mới sẽ [[surprise|làm bất ngờ]] bạn theo cách dễ chịu.`,
  },
  {
    ...
    content: `Tôi kể cho bạn gái nghe [[climate|khí hậu]] Việt Nam có hai [[season|mùa]] rõ rệt. Vào [[beginning|sự khởi đầu]] mùa hè, trời [[sunny|nhiều nắng]] và [[humid|ẩm]] — thời tiết [[typical|điển hình]].
...
Vào [[middle|giữa]] mùa, một [[typhoon|bão nhiệt đới]] gây [[flood|lũ lụt]], mưa [[last|kéo dài]] cả một [[period|khoảng thời gian]] dài. Đến [[end|sự kết thúc]] mùa trời lại quang đãng; tôi và cô ấy ngồi bên nhau, ấm cúng.`,
  },
  {
    ...
    content: `Cuối tuần, tôi và bạn gái cùng [[prepare|chuẩn bị]] bữa tối. Chúng tôi mua [[groceries|thực phẩm tạp hóa]] gồm [[beef|thịt bò]], [[pork|thịt lợn]] và [[bacon|thịt ba chỉ xông khói]].
...
Tôi đói đến mức [[hangry|cáu vì đói]], [[stomach|dạ dày]] kêu òng ọc. Khi cô ấy [[serve|phục vụ]] món lên, mọi thứ thật [[yummy|ngon]]!`,
  },
  {
    ...
    content: `Một tối, tôi và bạn gái ghé [[pub|quán rượu]] cùng bạn bè; tôi khá [[thirsty|khát nước]]. Chúng tôi gọi vài [[bottle|chai]] [[beer|bia]] và một [[glass|cốc thủy tinh]] [[wine|rượu vang]].
...
Để [[detox|thải độc]], cô ấy [[stir|khuấy]] một [[litre|lít]] nước [[sparkling|có ga]] với chanh, đổ đầy một [[bucket|xô]] đá. Tôi quyết bỏ [[habit|thói quen]] uống nhiều.`,
  },
  {
    ...
    content: `Tôi thử [[cooking|nấu ăn]] theo một [[recipe|công thức]] [[secret|bí mật]] của mẹ. Bí quyết là [[seasoning|gia vị]]: [[add|thêm]] một chút để [[flavour|hương vị]] đậm hơn.
...
Vì [[hunger|cơn đói]], chúng tôi ăn sạch, chẳng còn [[leftovers|đồ ăn thừa]]. Hôm bận thì gọi [[takeaway|đồ ăn mang đi]] — nền [[cuisine|ẩm thực]] Việt có quá nhiều món ngon.`,
  },
  {
    ...
    content: `Chúng tôi quyết định [[follow|tuân theo]] một [[diet|chế độ ăn]] [[strict|nghiêm ngặt]] hơn để [[stay|giữ]] khoẻ. Đồ ăn nhanh nhiều [[sugar|đường]] vừa [[crappy|tồi tệ]] vừa [[tiring|gây mệt mỏi]].
...
Cô ấy [[mix|trộn]] nhiều loại [[crop|cây trồng]] cho đủ [[variety|sự đa dạng]]: [[pea|đậu Hà Lan]], rau [[leaf|lá]] xanh, và nhớ [[peel|gọt vỏ]] sạch trước khi ăn.`,
  },
  {
    ...
    content: `Sau nhà, chúng tôi [[plant|trồng]] một vườn nhỏ và chờ ngày [[harvest|thu hoạch]]. Vài hạt đã [[sprout|nảy mầm]]: [[cabbage|bắp cải]], [[lettuce|rau xà lách]], [[onion|hành tây]] và [[mushroom|nấm]].
